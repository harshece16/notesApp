...
import com.hg.sba.reposotory.NotesRepository;
...
public class NotesController {
	...
	public ResponseEntity<Notes> createNotes(@RequestBody Notes notes) {
	  try {
	    Notes _note = notesRepo.save(new Notes(notes.getTitle(), notes.getDescription(), notes.getStatus()));
